#A supermarket wants to analyze customer purchasing behavior in order to discover relationships among products that are frequently bought together. The transaction data collected over five days is shown in the table below.
